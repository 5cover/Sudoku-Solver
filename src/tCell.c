...
// Using macros to maximize the performance of these simple functions and
// procedures called very frequently in the program.
...
/// @return A boolean indicating whether @p cell has @p candidate as a
/// candidate.
...
/// @return The first value in the range [1 ; @ref SIZE] that is a candidate of
/// @p cell.
